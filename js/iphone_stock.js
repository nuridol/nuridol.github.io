...
function getPickupData2(preData) {
    var url = 'https://www.apple.com/jp/shop/retail/pickup-message?pl=true&searchNearby=true&store=R048&parts.0=MQAX2J/A&parts.1=MQAY2J/A&parts.2=MQC12J/A&parts.3=MQC22J/A';
    // get json data
    $.ajax({
...
function getPickupData() {
    var url = 'https://www.apple.com/jp/shop/retail/pickup-message?pl=true&searchNearby=true&store=R224&parts.0=MQAX2J/A&parts.1=MQAY2J/A&parts.2=MQC12J/A&parts.3=MQC22J/A';
    // get json data
    $.ajax({
      url: "https://query.yahooapis.com/v1/public/yql?"+ "q=select%20*%20from%20json%20where%20url%3D%22"+ encodeURIComponent(url)+ "%22&format=json",
      //url: "pickup.json",
